...
const UploadPage = () => {
  ...
  return (
    <div className="text-base">
      ...
      <div>
        <input className="border my-2 p-2" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} />
      </div>
      <div>
        <input className="border my-2 p-2" placeholder="Type" value={type} onChange={(e) => setType(e.target.value)} />
      </div>
      <div>
        <input
