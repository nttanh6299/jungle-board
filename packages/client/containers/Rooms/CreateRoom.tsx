      ...
      <div className="flex">
        <Show when={showInput}>
          ...
          <div className="flex flex-col ml-4">
            <label className="block mb-1 text-md font-medium text-gray-900" htmlFor="maxMove">
              Max move
            </label>
            <select
              ref={maxMoveRef}
          ...
          <div className="flex flex-col ml-4">
            <label className="block mb-1 text-md font-medium text-gray-900" htmlFor="cooldown">
              Cooldown
            </label>
            <select
              ref={cooldownRef}
